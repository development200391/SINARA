...
public interface IConfigApiClient
{
    ...
    Task<ApiCallResult<object?>> DeleteUserAsync(string accessToken, int id, CancellationToken ct = default);
    ...
    Task<ApiCallResult<object?>> UpdateRolePermissionsAsync(string accessToken, int roleId, PermissionMatrixDto request, CancellationToken ct = default);

    Task<IReadOnlyList<ModuleDto>> GetModulesAsync(string accessToken, CancellationToken ct = default);
    Task<ApiCallResult<ModuleDto>> UpdateModuleAsync(string accessToken, int id, ModuleDto request, CancellationToken ct = default);
    ...
    Task<ApiCallResult<MenuDto>> CreateMenuAsync(string accessToken, MenuDto request, CancellationToken ct = default);
    Task<ApiCallResult<MenuDto>> UpdateMenuAsync(string accessToken, int id, MenuDto request, CancellationToken ct = default);
    Task<ApiCallResult<object?>> DeleteMenuAsync(string accessToken, int id, CancellationToken ct = default);
    Task<ApiCallResult<object?>> ReorderMenusAsync(string accessToken, int moduleId, IReadOnlyList<int> orderedMenuIds, CancellationToken ct = default);
    ...
    Task<ApiCallResult<AppSettingsDto>> UpdateSettingsAsync(string accessToken, AppSettingsDto request, CancellationToken ct = default);
